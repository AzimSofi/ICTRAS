...
if(strlen($_SESSION['login'])==0 )
{
  ...
  if(isset($_POST['submit']))
  {
    ...
    $reason=$_POST['reason'];
    $CGPA=$_POST['CGPA'];
    $ret=mysqli_query($con,"insert into courseenrolls(studentname,studentRegno,programme,email,handphonenum,address,institution,diploma,degree,yearofstudy,reason,CGPA) values('$studentname','$studentregno','$programme','$email','$handphonenum','$address','$institution','$diploma','$degree','$yearofstudy','$reason','$CGPA')");
