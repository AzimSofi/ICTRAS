...
<body>
  <div class="navbar navbar-fixed-top">
          ...
          <div class="span3">
            <div class="sidebar">
              <ul class="widget widget-menu unstyled">
                ...
                <li><a href="transfer_application.php"><i class="menu-icon icon-inbox"></i>Application</a>
                </li>
    ...
    <div class="footer">
      <div class="container">
        <a href="http://www.iium.edu.my/">IIUM Website</a> |
        <a href="https://italeem.iium.edu.my/">I-Ta'leem</a> |
      </div>
    </div>
    <!--/.wrapper-->
