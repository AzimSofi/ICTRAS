...
if(isset($_POST["submit"]))
{
  ...
  $query = "select * from ictras.ecourses
  where ( universities like '%$search%' or ecoursecode like '%$search%' or department like'%$search%');";
      ...
      <div class="wrapper">
        <div class="container">
          <div class="row">
            ...
            <div class="span9">
              <form class="form-horizontal row-fluid" action="ecourse.php" method="post">
                <div  class="control-group">
                  <label class="control-label" for="Search"><b>Search:</b></label>
                  <div class="controls">
                    <input type="text" id="text" name="search" placeholder="Enter Matric/university/Endorse Course/Department" class="span8" required>
                    <button type="submit" name="submit"class="btn btn-primary">Search</button>

                    <a href="editcourses.php"  class="btn btn-primary">Add Course</a>
                  </div>
                </div>
              </form>
              <div class="module">
                <div class="module-head">
                  <h3>List Endorsed Courses  </h3>
                </div>
                  ...
                  <table class="table" id = "tables">
                    ...
                    <tbody>
                      ...
                      foreach($searchlist as $row)
                      {
                        ...
                        $ecoursecode=$row['ecoursecode'];
                        $coursecode=$row['coursecode'];
                        $status=$row['status'];
                       ?>
                      <tr>
                        <td><?php echo $universities  ?></td>
                        <td><?php echo $programme  ?></td>
                        <td><?php echo $department  ?></td>
                        <td><?php echo $coursecode ?></td>
                        <td><?php echo $ecoursecode ?></td>
