<div class="list-group mb-3">
    ...
    <a href="{{ route('hod.index') }}" class="list-group-item list-group-item-action">Home</a>
    <a href="{{ route('hod.student-application.index') }}" class="list-group-item list-group-item-action">Student Applications</a>
